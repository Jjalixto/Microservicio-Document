...
class OneOwner(ContractStrategy):
    ...
    def counted_type(request: DocumentRequest, document: Document):
        ...
        ruta_pdf = OneOwner.convertir_word_a_pdf(ruta_word, output_folder)
    ...
    def financed_type(request: DocumentRequest, document: Document):
        ...
        OneOwner.actualizar_documento_word_excel(ruta_word, tabla_datos, parametros)
    ...
    def fractionated_type(request: DocumentRequest, document: Document):
        ...
        'texto_12': f'(i)	La suma de US$ {float(request.saldo_restante):,.2f} ({request.saldo_restante_letras} con 00/100 dólares americanos), a más tardar el – de – de 202-. \n (ii)	La suma de US$ --- (--- con 00/100 dólares americanos), a más tardar el – de – de 202-. \n (iii)	(….)',
    ...
    def actualizarCamposEspecificos(ruta_word, parametros):
        ...
        valores = {
            ...
            '${cuota_armada}': str(parametros['cuota_inicial']),
